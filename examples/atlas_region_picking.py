#!/usr/bin/env python3
"""Hover and select a D070 atlas region using stable face identities."""
...
def main() -> int:
    """Open the atlas surface with stable face picking enabled."""
    ...
    with AtlasViewer.from_asset_set(
        ...
        if args.offscreen:
            ...
            viewer.show(title='IBL atlas region picking', frame_count=args.frames)
    return 0
